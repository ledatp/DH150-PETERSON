...
<br/> 
### 5: Error Prevention
Although it has its flaws, Duolingo locks certain lesson plans (which is indicated clearly by a grey image) that they have deemed as more difficult based on how you perform during the placement test. In some instances, it is not quite clear how they categorize which lesson should be locked, but some lessons are an extensions of previous ones. By having these locked, it ensures that its user are completely ready to take on the lesson. This is a form of error prevention as it protects users from overestimating their abilities and prevents guessing and skipping difficult question to complete the lesson for EXP points. In addition, I believe the general minimalist design, which can be seen in Nielson's Heuristic 8, of the site also act towards preventing errors. With a site with limited features to be pressed, it is very difficult to make mistakes. From creating accounts to advancing in lessons, everything is laid out in plain text that help users understand the site's possibilities.<br/>
<br/> 
